...
<body>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						...
						<li><a href="#"><i class="fa fa-wrench fa-fw"></i> UI
								Elements<span class="fa fa-angle-right"></span></a>
							<ul class="nav nav-second-level">
						...
						<li><a href="#"><i class="fa fa-sitemap fa-fw"></i>
								Multi-Level Dropdown<span class="fa fa-angle-right"></span></a>
							<ul class="nav nav-second-level">
						...
						<li><a href="#"><i class="fa fa-files-o fa-fw"></i>
								Sample Pages<span class="fa fa-angle-right"></span></a>
							<ul class="nav nav-second-level">
	...
	<script
		src="<c:url value="/resources/bower_components/raphael/raphael-min.js"/>"></script>
	<script
		src="<c:url value="/resources/bower_components/morrisjs/morris.min.js"/>"></script>
