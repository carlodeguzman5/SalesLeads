...
<head>
    ...
    <!-- Timeline CSS -->
    <link
	href="<c:url value="/resources/dist/css/timeline.css" />"
	rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
                ...
                <select class="example" style="display:none">
        			<option>this</option>
        		...
        		<select class="example" style="display:none">
        			...
        			<option>this is a test</option>
                            ...
                            <button onclick="timeLineCreateLeft()">timeline left</button><button onclick="timeLineCreateRight()">timeline right</button>
